...
import 'package:latihan3/models/note.dart';
import 'package:latihan3/untils/database_helper.dart';
...
class NoteDetailState extends State<NoteDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    // telpController.text = note.telp;
    // emailController.text = note.email;
    // almtController.text = note.almt;
  ...
  // void updateTelp() {
  //   note.telp = telpController.text;
  // }

  // void updateAlmt() {
  //   note.almt = almtController.text;
  // }
